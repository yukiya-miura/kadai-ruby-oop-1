...
# インスタンスの使用
Kyojin.show_team_result("Giants")
Hannshin.show_team_result("Tigers")
Chuunichi.show_team_result("Dragons")
Yokohama.show_team_result("BayStars")
Hiroshima.show_team_result("Carp")
Yakuruto.show_team_result("Swallows")